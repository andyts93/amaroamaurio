...
export default function Home() {
  return (
    <>
        ...
        <section className="bg-orange-100 rounded-xl p-6 shadow-brutal border border-black mt-8" id="storia">
        ...
        <section className="bg-sky-100 rounded-xl p-6 shadow-brutal border border-black mt-8" id="ricetta">
        ...
        <section className="bg-violet-100 rounded-xl p-6 shadow-brutal border border-black mt-8" id="acquista">
